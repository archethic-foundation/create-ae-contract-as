...
createSampleFiles(root)
createScriptsDir(root)
createTestsDir(root)
...
function createScriptsDir(root) {
    fs.mkdirSync(path.join(root, "scripts"))
    fs.writeFileSync(
        path.join(root, "scripts", "deploy.js"),
        fs.readFileSync(path.join(TPL_DIR, "scripts", "deploy.js")),
    )

    fs.writeFileSync(
        path.join(root, "scripts", "upgrade.js"),
        fs.readFileSync(path.join(TPL_DIR, "scripts", "upgrade.js")),
    )
}
...
function createConfigFiles(root) {
    ...
    fs.writeFileSync(
        path.join(root, "archethic.config.js"),
        fs.readFileSync(path.join(TPL_DIR, "archethic.config.js")),
    )
...
function createSampleFiles(root) {
    fs.writeFileSync(
        ...
        fs.readFileSync(path.join(TPL_DIR, "client.js")),
    )
